...
class TestHero(TestCase):
    ...
    def test_battle_hero_with_zero_hero_energy_raises_value_error(self):
        self.hero.health = 0
    ...
    def test_fight_enemy_with_zero_enemy_health_raises_exception(self):
        self.enemy.health = 0
        with self.assertRaises(ValueError) as ve:
            self.hero.battle(self.enemy)
    ...
    def test_battle_enemy_removed_health_after_draw(self):
        self.hero.health = 50
    ...
    def test_battle_enemy_and_lose_expect_enemy_stats_increase(self):
